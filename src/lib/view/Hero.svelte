...
<section
  ...
  class="w-full h-[80vh] md:h-screen flex justify-center items-center"
>
  <div
    class="w-full md:w-[50%] flex flex-col items-center space-y-6 text-center"
  >
    <div
    ...
    <div class="w-full md:w-[70%] space-y-2">
      ...
      <form class="w-full flex items-center space-x-2">
        ...
        <Button type="submit" class="h-fit">Subscribe</Button>
      </form>
    </div>
  </div>
</section>
